...
class DocPainter : public QWidget
{
    Q_OBJECT
public:
    explicit DocPainter(QWidget *parent = nullptr);
...
private:
    ...
    QVector<TextElement1> Left_block_List11_textElements = {
        ...
        {11.5, 91.2, 2.9, 90, "HVCenter90", "", "Инв. № дубл.", 23.5},
        {11.5, 66.4, 2.9, 90, "HVCenter90", "", "Взам. инв. №", 23.5},
        {11.5, 36.4, 3.5, 90, "HVCenter90", "", "Подп. и дата", 33.5},
        {11.5, 6.7, 2.9, 90, "HVCenter90", "", "Инв. № подл.", 23.5}
    };
